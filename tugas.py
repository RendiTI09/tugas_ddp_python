...
print("Gaji Pokok \t \t : Rp.", gaji_pokok1)
print("Tunjangan Jabatan \t : Rp.", tunjangan_jabatan1)
print("Tunjangan Keluarga \t : Rp.", tunjangan_keluarga1)
print("Gaji Kotor \t \t : Rp.", gaji_kotor1)
print("Zakat Profesi \t \t : Rp.", zakat_profesi1)
print("Take Home Pay \t \t : Rp.", gaji_bersih1)
print(" ")
